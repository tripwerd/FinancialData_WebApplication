                ...
                {earnings.revenueEstimated && (
                  <>
                    ...
                    <span className="relative">
                      <span className="absolute right-full top-1/2 mr-1.5 -translate-y-1/2 whitespace-nowrap text-xs uppercase tracking-wider text-text-muted">Fwd Rev</span>
              ...
              <div className="flex items-center gap-1.5">
                {earnings.epsEstimated && price && (
                  <>
                    ...
                    <span className="relative">
                      <span className="absolute right-full top-1/2 mr-1.5 -translate-y-1/2 whitespace-nowrap text-xs uppercase tracking-wider text-text-muted">Fwd Earn</span>
