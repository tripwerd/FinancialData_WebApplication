                ...
                {earnings.revenueEstimated && (
                  <>
                    ...
                    <span className="relative inline-flex items-center">
                      <span className="absolute right-full mr-1.5 top-0 bottom-0 flex items-center whitespace-nowrap text-xs uppercase tracking-wider text-text-muted">Fwd Rev</span>
              ...
              <div className="flex items-center gap-1.5">
                {earnings.epsEstimated && price && (
                  <>
                    ...
                    <span className="relative inline-flex items-center">
                      <span className="absolute right-full mr-1.5 top-0 bottom-0 flex items-center whitespace-nowrap text-xs uppercase tracking-wider text-text-muted">Fwd Earn</span>
